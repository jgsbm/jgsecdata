...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { pic: @product_image.pic, product_id: @product_image.product_id, version: @product_image.version }
    end
  ...
  test "should update product_image" do
    patch :update, id: @product_image, product_image: { pic: @product_image.pic, product_id: @product_image.product_id, version: @product_image.version }
    assert_redirected_to product_image_path(assigns(:product_image))
  end

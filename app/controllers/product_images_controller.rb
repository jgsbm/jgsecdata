class ProductImagesController < ApplicationController
  before_action :set_product_image, only: [:show, :edit, :update, :destroy, :pic]

  def pic
    send_data(@product_image.pic, disposition: :inline)
  end
  ...
  private
    ...
    def product_image_params
      params.require(:product_image).permit(:product_id, :version)
    end
end
